...
tfm.exec.setUIMapName("Caduta blocchi!")
setMapTitle("Premi la spacebar per prendere un bonus o per respawnare!")
generateMap()
managePlayers()
newBonus()
loading = true
...
bonus[2]["title"] = "Spawna i Trampolini."
...
bonus[3] = {}
bonus[3]["name"] = "Lava"
bonus[3]["title"] = "Trasforma in lava delle piattaforme."
...
bonus[4]["title"] = "Fertilizza delle piattaforme."
...
bonus[5] = {}
bonus[5]["name"] = "Wind"
bonus[5]["title"] = "Soffia su delle piattaforme."
bonus[5]["particles"] = 1
bonus[5]["speed"] = false
bonus[5]["id"] = 10
...
title = "Scalata al Successo by Themiachale | " .. title
for k=#title, 199 do
title = title .. " "
end
ui.setMapName(title)
...
setMapTitle("Sta per iniziare una nuova partita.")
...
if timer < 5 then
setMapTitle("Una nuova partita inizierà in " .. math.ceil(timer) .. " secondi...")
end
timer = timer - 0.5
end
end
...
setMapTitle(playerName .. " Ha vinto in " .. timeElapsed/100 .. " secondi.")
gameEnded = true
end
end
