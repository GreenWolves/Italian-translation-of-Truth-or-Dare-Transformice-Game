...
lang.it = {
  ask_word = "Digita la parola da indovinare",
  choose_word = "Scegli una parola: (tra 2 e 12 lettere)",
  more_players = "Dovete essere almeno in <font color='#FF0006'>2</font> per giocare a l'Impiccato.",
  next_turn_1 = "Prossimo turno in ",
  next_turn_2 = " secondi.",
  turn_of_1 = "È il turno di ",
  turn_of_2 = "! ",
  patientez = "Aspettando che scelga una parola...",
  word_found = "La parola è stata indovinata, complimenti!",
  word_not_found = "Avete perso, che sfortuna... La parola era ",
  time_out = "Tempo scaduto!",
  pass_turn = "Il giocatore ha passato il turno!",
  quit = "Il giocatore è uscito"
}
...
tfm.exec.setUIMapName("Impiccato | Tradotto by Themiachale")
  timer = timer + 0.5
  if beginReset then
